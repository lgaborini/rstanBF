...
rstanBF provides a function to estimate the hyperparameters:
...
Models often implement draws from the prior predictive distribution.

The names of the variables start with `sim_`:
```{r}
